    ...
    return (
        <Layout>
            ...
            <main className="max-w-4xl mx-auto pt-4 md:pt-10">
                ...
                */}
                        <p className="text-zinc-300 mb-4 lowercase text-lg md:text-xl ml-[3px] md:ml-[5px]">hi, i&apos;m mahaprasad</p>
                ...
                <FadeInStagger className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 text-zinc-400 font-light text-lg leading-relaxed lowercase pb-24 md:pb-32">
                    <FadeInItem>
                        <div className="space-y-6">
                            ...
                            <p>
                                master&apos;s in data science from <span className="text-foreground text-glow">vit vellore</span>. <br />btw, i use <span className="text-foreground text-glow">fedora</span>.
                            </p>
                        </div>
                    </FadeInItem>
                        ...
                        <div className="flex flex-col justify-between h-full">
                            <div>
                                ...
                                <div className="flex flex-col gap-3 text-xl">
                                    <RollingLink href="https://github.com/Mahaprasad003" target="_blank" className="text-zinc-400 hover:text-foreground hover:text-glow">
                                        <span className="flex items-center gap-3"><Github size={20} /> github</span>
                                    </RollingLink>
                                    <RollingLink href="https://x.com/mahaprasad_" target="_blank" className="text-zinc-400 hover:text-foreground hover:text-glow">
                                        <span className="flex items-center gap-3"><Twitter size={20} /> twitter</span>
                                    </RollingLink>
                                    <RollingLink href="https://www.linkedin.com/in/mahaprasad003/" target="_blank" className="text-zinc-400 hover:text-foreground hover:text-glow">
                                        <span className="flex items-center gap-3"><Linkedin size={20} /> linkedin</span>
                                    </RollingLink>
                                    <RollingLink href="mailto:mahaprasad003@gmail.com" className="text-zinc-400 hover:text-foreground hover:text-glow">
